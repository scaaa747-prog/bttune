...
import com.bt.bttune.ui.component.LyricsBackgroundType
import com.bt.bttune.ui.component.LyricsCardConfig
import com.bt.bttune.ui.component.LyricsGlassStyle
import com.bt.bttune.ui.component.LyricsLayoutStyle
...
object BTTUNEComposeToImage {
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // Helper: branding BTTUNE (igual al original)
    // ─────────────────────────────────────────────────────────────────────────
    ...
    private fun drawBranding(
        ...
        val rawLogo   = context.getDrawable(R.drawable.bttune)?.toBitmap(logoSize, logoSize)
    ...
    fun saveBitmapAsFile(context: Context, bitmap: Bitmap, fileName: String): Uri {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues = ContentValues().apply {
                ...
                put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/BTTUNE")
            }
